                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" value="{{$user->name}}" class="form-control" id="name" name="name" placeholder="নাম লিখুন" />
                                    @error('name')
                        ...
                        <div class="col-sm-6">
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" value="{{$user->email}}" class="form-control" id="email" name="email" placeholder="ইমেইল লিখুন" />
                                    @error('email')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" value="{{$user->phone}}" class="form-control" id="phone" name="phone" placeholder="মোবাইল নাম্বার লিখুন" />
                                    @error('name')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-5">
                                    <select name="donar_type" id="donar_type" class="form-select">
                                        ...
                                        @if($row->type_name==$user->donar_type)
                                ...
                                <div class="col-sm-4">
                                        <input type="text" value="{{$numberToBangla->bnNum($user->amount)}}" class="form-control" id="amount" name="amount" placeholder="চাঁদার পরিমান লিখুন">
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" value="{{$user->village}}" class="form-control" id="village" name="village" placeholder="গ্রাম/মহল্লা/বাসা নাম্বার লিখুন" />
                        ...
                        <div class="col-sm-6">
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" value="{{$user->post}}" class="form-control" id="post" name="post" placeholder="ইমেইল লিখুন" />
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" value="{{$user->upzila}}" class="form-control" id="upzila" name="upzila" placeholder="উপজেলার নাম লিখুন" />
                        ...
                        <div class="col-sm-6">
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" value="{{$user->district}}" class="form-control" id="district" name="district" placeholder="জেলার লিখুন" />
